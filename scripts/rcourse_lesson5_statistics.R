...
## BUILD MODELS ####
# Linear model
incumbent.lm = lm(perc_incumbent_mean ~ incumbent_party * civil_war, data = data_stats)
incumbent.lm = lm(perc_incumbent_mean ~ relevel(incumbent_party, "republican") * civil_war, data = data_stats)

incumbent.lm_sum = summary(incumbent.lm)
incumbent.lm_sum
