...
data_elections = read.table("data/rcourse_lesson4_data_elections.txt", header=T, sep="\t")

# Read in extra data bout specific states
data_states = read.table("data/rcourse_lesson4_data_states.txt", header=T, sep="\t")
